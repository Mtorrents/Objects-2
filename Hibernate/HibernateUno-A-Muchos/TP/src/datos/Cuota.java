...
public class Cuota {
	...
	public Cuota(int nroCuota, LocalDate fechaDeVencimiento, double saldoPendiente, double amortizacion,
			double interesCuota, double cuota, double deuda,double punitorios, LocalDate fechaDePago, Prestamo prestamo) {
		super();
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + (int) (idCuota ^ (idCuota >>> 32));
		return result;
	}

	public boolean equals(Cuota obj) {
		return idCuota == obj.getIdCuota();
	}

	@Override
	public String toString() {
		return "Cuota [idCuota=" + idCuota + ", nroCuota=" + nroCuota + ", fechaDeVencimiento="
				+ Funciones.traerFechaCorta(fechaDeVencimiento) + ", saldoPendiente=" + saldoPendiente
				+ ", amortizacion=" + amortizacion + ", interesCuota=" + interesCuota + ", cuota=" + cuota + ", deuda="
				+ deuda + ", cancelada=" + cancelada 
