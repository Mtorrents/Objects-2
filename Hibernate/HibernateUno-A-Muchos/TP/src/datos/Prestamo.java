...
public class Prestamo {
	...
	public boolean eliminar(Cuota cuota) {
	...
	public boolean equals(Prestamo obj) {
		return idPrestamo == obj.getIdPrestamo();
	}

	@Override

	public String toString() {
		return (idPrestamo + "  Fecha:" + Funciones.traerFechaCorta(fecha) + "  Monto: " + monto + "  interes: "
				+ interes + "  Cantidad de cuotas: " + cantCuotas + "   \nCliente: " + cliente + ", cancelado="
				+ cancelado);
	}
}